...
def _normalize_face_canonical_result(node: Any) -> Dict[str, Any]:
    ...
    return {
        ...
        "head_topology_partition": raw.get("head_topology_partition"),
        "head_topology_mean_similarity": raw.get("head_topology_mean_similarity"),
        "head_topology_weakest_part": raw.get("head_topology_weakest_part"),
        "head_topology_weakest_part_similarity": raw.get("head_topology_weakest_part_similarity"),
        "head_topology_upper_face_similarity": raw.get("head_topology_upper_face_similarity"),
        "head_topology_mid_face_similarity": raw.get("head_topology_mid_face_similarity"),
        "head_topology_lower_face_similarity": raw.get("head_topology_lower_face_similarity"),
        "head_topology_contour_similarity": raw.get("head_topology_contour_similarity"),
        "head_topology_center_axis_similarity": raw.get("head_topology_center_axis_similarity"),
        "head_topology_lateral_balance_similarity": raw.get("head_topology_lateral_balance_similarity"),
