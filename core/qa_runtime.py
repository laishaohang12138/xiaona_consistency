...
def _default_release_gates() -> Dict[str, Any]:
    raw_gates = {
        "BODY_GOLD.front_core": {
            ...
            "notes": "Front-core evidence receives priority external review when screening evidence is complete.",
        },
        "BODY_GOLD.three_quarter_review": {
            ...
            "notes": "Three-quarter evidence remains on hold until canonical truth and frozen benchmark coverage are stronger.",
        },
        "BODY_GOLD.side90_shadow": {
            "release_state": "shadow",
            "machine_status_ceiling": "WARN",
            "external_review_route": "SHADOW_EVIDENCE_ONLY",
            "requires_frozen_benchmark": True,
            "required_lane_families": ["side"],
            "notes": "Side-90 is shadow evidence and cannot express final image-set membership or training admission.",
        },
        "BODY_GOLD.back180_shadow": {
            ...
            "notes": "Back-180 is shadow evidence and cannot express final image-set membership or training admission.",
        },
        "BRIDGE.simple_outfit": {
            ...
            "notes": "Stable simple-outfit continuity receives priority external review.",
        },
        "BRIDGE.review": {
            "release_state": "review",
            "machine_status_ceiling": "WARN",
            "external_review_route": "STANDARD_REVIEW",
            "required_lane_families": ["front", "three_quarter", "side", "back"],
            "notes": "Generic full-body outfit evidence is routed for standard external review.",
        },
        "UPPER_BODY_PRODUCT": {
            "release_state": "review",
            "machine_status_ceiling": "WARN",
            "external_review_route": "STANDARD_REVIEW",
            "required_lane_families": ["front", "three_quarter"],
            "notes": "Upper-body product evidence is routed for standard external review.",
        },
        "IDENTITY_LOCK": {
            "release_state": "review",
            "machine_status_ceiling": "WARN",
            ...
            "notes": "Identity-lock output is screening evidence for external review.",
        },
        "IDENTITY_FILTER_ONLY": {
            ...
            "external_review_route": "SHADOW_EVIDENCE_ONLY",
            "required_lane_families": ["front", "three_quarter", "side"],
            "notes": "Identity-filter output is diagnostic shadow evidence only.",
        },
    }
    return {
        "schema_version": RELEASE_GATE_SCHEMA_VERSION,
        "release_gates": {
            bucket: fail_closed_release_gate(
                gate,
                target_bucket=bucket,
                source_schema_version=RELEASE_GATE_SCHEMA_VERSION,
            )
            for bucket, gate in raw_gates.items()
        },
    }
...
def _normalize_release_gates(data: Any) -> Dict[str, Any]:
    return normalize_release_gate_config(data, _default_release_gates())
